// app/catalog/horizontal/page.tsx
import { Container } from '@/components/ui/Container';
import { GlassCard } from '@/components/ui/GlassCard';
import { SectionTitle } from '@/components/ui/SectionTitle';
import { horizontalPumpsData } from '../horizontalPumps';
import { Gauge, Factory, Shield, Droplets, Cpu, Zap } from 'lucide-react';

export default function HorizontalPumpsPage() {
  const data = horizontalPumpsData;
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <GlassCard>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between border-b border-navy-700 pb-2">
                <span className="text-slate-400">КПД</span>
                <span className="text-white font-medium">{data.specs.efficiency}</span>
              </div>
              <div className="flex justify-between border-b border-navy-700 pb-2">
          ...
          <GlassCard className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {data.versions.map((version, idx) => (
                <div key={idx} className="bg-navy-800/50 rounded-lg p-4">
                  <h4 className="text-white font-semibold text-sm mb-2">{version.name}</h4>
                  <p className="text-slate-400 text-xs leading-relaxed">{version.description}</p>
                </div>
              ))}
            </div>
          </GlassCard>
