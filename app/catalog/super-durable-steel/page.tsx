// app/catalog/super-durable-steel/page.tsx
import { Container } from '@/components/ui/Container';
import { GlassCard } from '@/components/ui/GlassCard';
import { SectionTitle } from '@/components/ui/SectionTitle';
import { superSteelPumpsData } from '../superSteelPumps';
import { Gauge, Factory, Shield, Droplets, Cpu, Zap, HardDrive } from 'lucide-react';

export default function SuperSteelPumpsPage() {
  const data = superSteelPumpsData;
    ...
    <main className="min-h-screen bg-navy-900 pt-24 pb-16">
      <Container>
          ...
          <GlassCard>
            ...
            <div className="space-y-3">
              <div className="flex justify-between border-b border-navy-700 pb-2">
                ...
                <span className="text-white font-medium">{data.specs.material}</span>
              </div>
              <div className="flex justify-between border-b border-navy-700 pb-2">
              ...
              <div className="flex justify-between border-b border-navy-700 pb-2">
                <span className="text-slate-400">pH диапазон</span>
                <span className="text-white font-medium">{data.specs.pH}</span>
              </div>
            </div>
          </GlassCard>
        ...
        {data.models && (
          <div>
            <h2 className="text-white font-semibold text-lg mb-4 flex items-center gap-2">
              <HardDrive className="w-5 h-5 text-copper-400" />
              Таблица параметров моделей из Hardalloy
            </h2>
